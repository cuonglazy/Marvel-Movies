...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  $.widget.bridge('uibutton', $.ui.button)
	...
	if (isEdit == 'true') {
		url = '/AssignmentJava4/admin/video?action=edit&href=' + hrefOrigin; 
	}else{
		url = '/AssignmentJava4/admin/video?action=add';
	}
		var formData = {
		...
		$.ajax({
			...
			success: function(data) {
				window.location.href = "http://localhost:8080/AssignmentJava4/admin/video?action=view";
			},
