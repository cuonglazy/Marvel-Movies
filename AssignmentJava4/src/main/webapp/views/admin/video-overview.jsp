...
<body
							...
							<tbody>
								<c:forEach items="${videos}" var="item">
									<tr>
										...
										<td><img src='<c:url value="${item.poster}"/>' alt="" width="150px"
											height="150px" /></td>
										<td>
	...
	<script>
		...
		function deleteVideo(href) {
		      $.ajax({
		        url: "/AssignmentJava4/admin/video?action=delete&href=" + href
		      })
		        .then(function() {
		          window.location.href =
		            "http://localhost:8080/AssignmentJava4/admin/video?action=view";
		        })
		        .fail(function(error) {
